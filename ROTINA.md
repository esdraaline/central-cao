...
## Entregas
- Aguardar o entregador na entrada externa do prédio. Ex.: "entrega para o Cap PM Fulano de Tal, Oficial-Aluno do Pel X no CAES".

## Afastamentos
- Integral (DS) ou Parcial (planilhas na SAE) — depende de concessão do comando; contam como pontos perdidos.
- Limites: **50% por matéria** / **75% do curso**.
- Todo afastamento (DS, convalescença, licença compulsória, paternidade etc.) precisa de regularização + publicação em Boletim Interno — enviar o comprovante à SAE para publicação.

## Demandas
- Ver ordem de contato em [CONTATOS.md](CONTATOS.md): Chefe de Turma → Chefe da Seção responsável.

## SIPA — financeiro
- **Não** será sacado o Programa Copa.
- Será sacado **Alojamento (pernoite)** R$ 30,35 **ou Vestiário** R$ 21,52, conforme opção (nunca os dois juntos).
- Será sacado **Fundo Escolar**: R$ 76,84.
- Se precisar, pedir para cessar os descontos de Alojamento/Vestiário/Programa Copa na OPM de origem, pra não cobrar em duplicidade.

## Ofício de Apresentação | SIPA
- Enviar para a mesa **SEI 302090130**.
...
- Todos recebem **Auxílio Financeiro a Estudantes** direto na conta do Banco do Brasil — **a conta não pode ser "Conta Salário"** e o nome **não pode estar no CADIN**.
- Aniversário (Recadastramento Anual e Inspeção de Saúde — IAS): pode ser feita na UIS da CORREG, CPA/M-1, ou na própria UIS do interessado; sem médico na UIS da CORREG, pode ser no CCB ou no CMed.
