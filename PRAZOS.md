...
| Data | Dia | O que |
|---|---|---|
| 13/08 | quinta | Acionar a P/1: Ofício de Apresentação na mesa SEI 302090130 + Rotina 13 do SIPA. Combinar a bagagem com o amigo da carona |
...
*(a preencher conforme Josemar for repassando — entregas de trabalhos, provas, apresentações, viagens para módulos presenciais etc.)*

- [ ] ...

## Histórico — processo seletivo (já concluído)
Fonte: Edital DEC-005/24/25 (CAO/26), Anexo A.

| Etapa | Data |
|---|---|
| Inscrição | 18/ago/25 a 01/set/25 |
| Análise das inscrições | 02 a 05/set/25 |
| Prova escrita (Etapa II) | 26/set/25 |
| Resultado da prova | até 03/out/25 |
| Defesa do PP (Etapa III) | 20 a 31/out/25 |
| Resultado da defesa | até 05/nov/25 |
| Resultado Final | até 24/nov/25 |
| Homologação | até 12/dez/25 |
| Publicação da homologação (Bol G PM) | até 17/dez/25 |
| Publicidade da Convocação | até 23/jan/26 |
| Início do curso — 1ª Turma (CAO-I/26) | fev/26 |
| **Início do curso — 2ª Turma (CAO-II/26, a minha)** | ago/26 |
