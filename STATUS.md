...
3. **Fardamento que faltou na ConfecBell/Confex Bel:** a **camisa social cinza-claro do S-1** e a
   **boina de reposição**. Ver [COMPRAS.md](COMPRAS.md).
...
- **Dentro do 1º ciclo não há módulo.** As **31 disciplinas correm em paralelo**, em blocos de 45
  minutos, várias por dia, e o **QTS sai semana a semana**. A mesma disciplina volta em semanas
  diferentes, às vezes com outro docente. Elas se agrupam em **6 matérias curriculares, que são a
  unidade de prova**. Rol completo, corpo docente e cobertura acumulada na [Grade](GRADE.md).
...
- **B-1 e EPI não sobem** e ficam em casa sem data nova (decisão de 20/08), enquanto o QTS não
