...
> Como funciona a vida no CAES: horário, uniforme, prédio, alojamento, SIPA e afastamento.
> O que levar está em [MALA.md](MALA.md), a grade da semana em [GRADE.md](GRADE.md), quem
...
*[VERIFICAR: dedução de 18/08 pelo cruzamento das aulas assistidas com as células "A" do QTS;
falta ratificar de viva voz na Coordenação]*.
...
- **Dia a dia do curso: P-1** (Art. 45) — camisa de passeio cinza-claro, calça social
  cinza-bandeirante, cinto de serviço, meias sociais pretas e sapatos pretos, com camiseta de
  serviço cinza-bandeirante por baixo.
- **Cobertura**: no curso o **quepe é substituído pela boina cinza-bandeirante** (Art. 45,
  § 1º, item 2, que trata de trânsito e atividades administrativas). Quepe só em cerimônia. A
  boina fica guardada no alojamento e vai na cabeça ao sair para área descoberta — **cobertura
...
- **Agasalho do P-1**: **jaqueta de passeio** (Art. 127), tecido panamá cinza-bandeirante,
  insígnias de posto em metal nas platinas e tarjeta administrativa. Também valem a blusa de
  lã (Art. 117) e o capote (Art. 121). A **japona é restrita ao efetivo do TOR** (Art. 124).
- **B-2 e B-3 não se aplicam**: B-2 é da Corregedoria (Art. 24) e B-3 é de patrulha montada
  (Art. 25).
...
**Não entra camiseta**, diferente do P-1.
...
**Platina do paletó: é fixa, não removível** (Art. 93, § 1º, item 4) — embutida na junção da
manga com o corpo, presa por botão dourado de 15 mm, com a estrela de metal espetada direto no
tecido. A platina rígida removível azul-ferrete (veludo, pentagonal, 140 x 60 mm) é só do
**R-1** (Art. 93, § 1º, item 6), uniforme de smoking, que não aparece no CAO.

**A platina da jaqueta de passeio do P-1 é igual** (Art. 127, item VI e parágrafo único, item
1), mudando só o botão, liso comum. Então **a mesma estrela serve nas duas peças**: 6 estrelas
de 25 mm por peça, ou um jogo só transferido de uma para a outra — o que não compensa, porque
o social fica guardado no CAES.
...
**Duas coisas para conferir antes de mandar costurar:**
...
1. **A bandeira e a logomarca de manga não estão no texto do Art. 93**, que só lista platinas,
   ...
   § 2º, que também é norma. Conferir a figura, não só o texto.
...
- Para guardar marmita: **1 geladeira na copa, 1 geladeira no refeitório e 2 frigobares**.
  São muitas pessoas usando as mesmas geladeiras, então **identifique os potes com o seu nome**.
- **Cafeteiras** disponíveis.
- **Sala de aula tem poucas tomadas** — levar extensão com várias saídas para o notebook.
- **Wi-fi da intranet funciona bem** (rede WCorp). Demandas de TIC: 0800 da DTIC.
- **Armário**: cerca de 1 folha de armário padrão da PM por aluno. Leve compacto.
- Bastante matéria e bastante instrutor — 2 cadernos.
- Os próprios alunos se organizam para melhorar o ambiente (comes e bebes da turma), com
...
- Alojamento e salas de aula **identificados com o nome de cada aluno**; não usar outras
  dependências.
- **O armário não tem chave: o cadeado é seu.**
- **Não fornece roupa de cama** — lençol de solteiro, fronha, travesseiro e cobertor vão de
  casa ([MALA.md](MALA.md)).
- **Material de limpeza também vai de casa.** A conservação de salas e alojamento é feita por
  escala dos próprios discentes.
- A farda social fica guardada no CAES durante o curso.
- **Estacionamento do CAO**: 40 vagas sinalizadas, **cartão de estacionamento visível**,
  pedido à AAp antes de viajar. Motocicletas: espaço coberto atrás do prédio. Viaturas: 20
  vagas sinalizadas defronte à OPM.
...
- Integral (DS) ou Parcial (planilhas na SAE) — depende de concessão do comando; contam como
  pontos perdidos.
- Limites: **50% por matéria** / **75% do curso**.
- Todo afastamento (DS, convalescença, licença compulsória, paternidade etc.) precisa de
  regularização + publicação em Boletim Interno — enviar o comprovante à SAE para publicação.
...
- É **ato eletrônico**: não existe via impressa para entregar no CAES. Ainda assim, ter o
  **número do processo anotado no celular**, para responder na hora se alguém perguntar.
- **Rotina 13 do SIPA liberada de 17/ago/26 a 22/jan/27**, no código **302090000**. Esse é o
  1º bloco financeiro/administrativo: **em 22/01/2027 vence e precisa ser renovado para o 2º**.
- Dependem disso: matrícula, adição, **Ajuda de Custo** (oficial de outro município) e
...
- [ ] Contratar empresa de evento (buffet, challenge coin, decoração, foto, filmagem, placas, mimos)
